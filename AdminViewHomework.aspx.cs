...
namespace ELearning
{
    public partial class AdminViewHomework : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (TextBox1.Text != "")
            {
                SqlCommand cmd = new SqlCommand("SELECT HomeworkId,StudId,Q1,Q2 FROM Upload WHERE HomeworkId=@HomeworkId AND StudId=@StudId" , con);
